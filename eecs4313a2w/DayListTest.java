...
public class DayListTest {
	...
	public void testDayList() {
		...
		/*
		 * Conditions: C1: Input is empty C2: Input has a comma seperator
		 * between "dlist" and the day values C3: Input doesn't have a comma
		 * seperator between "dlist" and the day values C4: Input has "dlist"
		 * but no numbers afterwards C5: Input contains a valid sequence of
		 * numbers C6: Non number after "dlist" C7: Non number in between
		 * numbers
		 * 
		 * Actions: A1: Return empty list A2: Return a list of the extracted
		 * numbers
		 * 
		 * 
		 * C1 -> A1 C2 -> A2 C3 -> A2 C4 -> A1 C5 -> A2
		 *
		 * 
		 */
